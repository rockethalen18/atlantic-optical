...
echo '<img src="/images/logo-light.png" alt="Atlantic Optical International Limited" class="sidebar-logo-img" style="height:160px;width:auto;max-width:100%">';
echo '</div></div>';
...
echo sidebar_item('descuentos', 'tag', 'Descuentos');
echo sidebar_item('bundles', 'box', 'Bundles');
echo sidebar_item('banners', 'image', 'Banners');
echo sidebar_item('popups', 'message-square', 'Popups');
