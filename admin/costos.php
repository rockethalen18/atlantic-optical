...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($type === 'shipping_rate') {
        ...
        $minW = floatval($_POST['min_weight'] ?? 0);
        $maxW = floatval($_POST['max_weight'] ?? 0);
...
$delId = $_GET['del'] ?? null;
$delType = $_GET['delt'] ?? null;
if ($delId && in_array($delType, ['shipping', 'exchange'])) {
    $table = $delType === 'shipping' ? 'shipping_rates' : 'exchange_rates';
    ...
    <div class="crm-layout">
        ...
        <main class="crm-main">
            <header class="crm-header">
                <h1>Costos y Tarifas</h1>
            </header>
            <div class="crm-content">
                <div class="crm-card">
                    <div class="crm-card-header">
                        <h2><?php echo crm_icon('globe'); ?> Tipo de Cambio (USD/DOP)</h2>
                    </div>
                        ...
                        <form method="POST" class="inline-form">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label>1 USD =</label>
                                    <input type="number" name="rate" step="0.01" min="0" value="<?php echo htmlspecialchars($exchangeRate); ?>" required>
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="btn-primary"><?php echo crm_icon('plus'); ?> Guardar</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="crm-table-wrap">
                        <table class="crm-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $er['currency_from']; ?></td>
                                    <td><?php echo $er['currency_to']; ?></td>
                                    ...
                                    <td><a href="costos.php?del=<?php echo $er['id']; ?>&delt=exchange" class="btn-sm btn-danger" onclick="return confirm('Eliminar?')"><?php echo crm_icon('trash'); ?></a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                    ...
                    <div class="crm-card-body">
                        <form method="POST" class="inline-form">
                            ...
                            <div class="form-row form-row-4">
                                <div class="form-group">
                                    <label>Zona</label>
                                    <input type="text" name="zone_name" placeholder="ej: Santo Domingo" required>
                                </div>
                                <div class="form-group">
                                    <label>Peso Min (kg)</label>
                                    <input type="number" name="min_weight" step="0.01" value="0">
                                </div>
                                <div class="form-group">
                                    <label>Peso Max (kg)</label>
                                    <input type="number" name="max_weight" step="0.01" value="50">
                                </div>
                                <div class="form-group">
                                    <label>Precio ($)</label>
                        ...
                        <table class="crm-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="costos.php?del=<?php echo $sr['id']; ?>&delt=shipping" class="btn-sm btn-danger" onclick="return confirm('Eliminar?')"><?php echo crm_icon('trash'); ?></a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
