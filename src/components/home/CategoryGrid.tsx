...
const categories = [
  {
    ...
    gradient: 'linear-gradient(135deg, #006535 0%, #00804a 50%, #00a86b 100%)',
    accent: 'rgba(0,168,107,0.15)',
    count: 55,
    size: 'lg' as const,
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg, #533483 0%, #7c3aed 50%, #a855f7 100%)',
  ...
  },
  {
    ...
    Icon: Icons.Eye,
    gradient: 'linear-gradient(135deg, #0d0d0e 0%, #2d2d3f 50%, #4a4a5e 100%)',
