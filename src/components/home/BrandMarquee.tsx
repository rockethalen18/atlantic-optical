      ...
      <div className="relative">
        ...
        <div ref={trackRef} className="flex gap-8 items-center whitespace-nowrap" style={{ width: 'max-content' }}>
          {[...brands, ...brands].map((brand, i) => (
            <div key={i} className="flex items-center gap-3 px-8 py-4 glass-card flex-shrink-0">
              <div className="w-10 h-10 bg-white/60 backdrop-blur-sm flex items-center justify-center flex-shrink-0 rounded-lg border border-white/50">
