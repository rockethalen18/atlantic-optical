    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="bg-[var(--dark-bg)] relative overflow-hidden text-white">
          ...
          <div className="max-w-[1680px] mx-auto px-6 md:px-10 py-14 md:py-20 relative z-10 text-center">
            <span className="text-[10px] font-bold text-[#60a5fa] uppercase tracking-[0.2em]">Contacto</span>
            <h1 className="text-[36px] md:text-[48px] font-black text-white tracking-[-0.04em] mt-2" style={{ fontFamily: 'var(--font-display)' }}>
              Hablemos de tu Proyecto
            </h1>
            <p className="text-[14px] text-white/60 mt-3 max-w-[400px] mx-auto">Solicita una cotizacion personalizada o resuelve tus dudas con nuestro equipo.</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="space-y-4">
              ...
              <div className="p-6 bg-[var(--green)] text-center text-white">
                ...
                <a href="#" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white text-[var(--green)] font-bold text-[11px] uppercase tracking-[0.08em] px-6 py-2.5 hover:bg-white/90 transition-colors">
