...
const steps = [
  { icon: Icons.Phone, title: 'Contacto', desc: 'Reporta el problema con tu equipo por telefono, email o WhatsApp.', color: '#0ea5e9' },
  { icon: Icons.CheckCircle, title: 'Diagnostico', desc: 'Nuestro equipo tecnico evalua la situacion y determina la accion correctiva.', color: '#0ea5e9' },
  ...
  { icon: Icons.Package, title: 'Devolucion', desc: 'Envio del equipo reparado o nuevo a tu ubicacion sin costo adicional.', color: '#0284c7' },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white relative overflow-hidden border-b border-[var(--border)]">
        ...
        <div className="max-w-[1680px] mx-auto px-6 md:px-10 py-14 md:py-20 relative z-10 text-center">
          <span className="text-[10px] font-bold text-[var(--blue)] uppercase tracking-[0.2em]">Proteccion</span>
          <h1 className="text-[36px] md:text-[48px] font-black text-[var(--text)] tracking-[-0.04em] mt-2" style={{ fontFamily: 'var(--font-display)' }}>
            Politica de Garantia
          </h1>
          <p className="text-[14px] text-[var(--text-muted)] mt-3 max-w-[400px] mx-auto">12 meses de garantia en todos nuestros equipos.</p>
        </div>
      </div>
