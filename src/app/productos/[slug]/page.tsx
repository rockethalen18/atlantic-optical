        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              <Link href="/contacto" className="inline-flex items-center justify-center gap-2 bg-[var(--blue)] text-white font-bold text-[12px] uppercase tracking-[0.08em] px-8 py-4 hover:bg-[var(--blue-hover)] transition-all hover:shadow-[0_16px_40px_rgba(14,165,233,0.3)] hover:-translate-y-0.5">
                <Icons.ShoppingCart size={14} />
                Solicitar Cotización
              </Link>
              <a href="https://wa.me/8613405595150" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold text-[12px] uppercase tracking-[0.08em] px-8 py-4 hover:bg-[#1da851] transition-all hover:shadow-[0_16px_40px_rgba(37,211,102,0.3)] hover:-translate-y-0.5">
