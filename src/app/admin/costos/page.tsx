        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-gradient-to-br from-[var(--green)] to-[var(--green-dark)] p-6 text-white">
            ...
            <div className="text-sm space-y-1 opacity-90">
              ...
              <p className="text-[#00ff88] font-medium mt-3">Ejemplo con ARK-7000:</p>
              <p>= ($2,800 × 2.2 + $4.50 × 12) × 17.50 × 1.16</p>
              <p className="text-lg font-bold text-[#00ff88]">= {formatMXN((exampleCost * exampleMargin + 4.50 * exampleWeight) * exchangeRate * (1 + taxRate/100))}</p>
            </div>
          </div>
        </div>
