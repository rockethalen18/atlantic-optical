    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-[var(--text)] relative overflow-hidden text-white">
        ...
        <div className="max-w-[1680px] mx-auto px-6 md:px-10 py-14 md:py-20 relative z-10 text-center">
          <span className="text-[10px] font-bold text-[#60a5fa] uppercase tracking-[0.2em]">Programa</span>
          ...
          <p className="text-[14px] text-white/60 mt-3 max-w-[400px] mx-auto">Unete a nuestra red de distribuidores en toda Latinoamerica.</p>
        </div>
      </div>
